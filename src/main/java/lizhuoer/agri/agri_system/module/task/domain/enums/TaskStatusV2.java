...
public final class TaskStatusV2 {
    ...
    public static final Map<String, Set<String>> TRANSITIONS = Map.of(
            PENDING_REVIEW, Set.of(PENDING_ACCEPT, REJECTED_REVIEW, CANCELLED, OVERDUE),
            PENDING_ACCEPT, Set.of(IN_PROGRESS, REJECTED_REASSIGN, CANCELLED, PENDING_ACCEPT, OVERDUE),
